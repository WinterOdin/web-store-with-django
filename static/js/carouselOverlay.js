...
$('.wrapperOverlayInner').each(function() {
    ...
    $slider.on('slide.changed', function() {
      ...
      $('.carouselList').removeClass('active');
      var $activeDot = $('.carouselList[data-slide="' + $('.panel._active').data('slide') + '"]');
