...
urlpatterns = [
	...
	path('controlPanelProductsDisplayed', panel.controlPanelProductsDisplayed, name='controlPanelProductsDisplayed'),
	path('controlPanelProductsStock', panel.controlPanelProductsStock, name='controlPanelProductsStock'),
